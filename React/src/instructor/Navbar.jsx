...
export default function Navbar() {
    ...
    const menuData = [
        { icon: "🏠", label: "หน้าหลัก", href: "/instructor/Dashboard" },
        { icon: "🙍🏻‍♂️", label: "วิชาเรียน", href: "/instructor/courses" },
         { icon: "🙍🏻‍♂️", label: "ห้องเรียน", href: "/instructor/classroom" },
        { icon: "👤", label: "ข้อมูลส่วนตัว", href: "/instructor/profile" },
